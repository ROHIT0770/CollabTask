...
│   ├── utils/             # Utility functions (e.g., notifications, file handling)
...
│   │   ├── pages/         # Main pages (e.g., Dashboard, Task Board)
...
## 🙏 **Acknowledgments**
- Special thanks to [OpenAI](https://openai.com) for providing tools that made this project possible.
